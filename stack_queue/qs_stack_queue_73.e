...
feature {QS_STACK_QUEUE_73}

	stack_plus (stack: QS_STACK_73): INTEGER
		note status: impure
		require
	...
	stack_minus (stack: QS_STACK_73): INTEGER
		note
			status: impure
		require
			two_things_on_stack: 2 <= stack.top
	...
	stack_division (stack: QS_STACK_73): INTEGER
		note
			status: impure
		require
			two_things_on_stack: 2 <= stack.top
	...
	stack_modulus (stack: QS_STACK_73): INTEGER
		note
			status: impure
		require
			two_things_on_stack: 2 <= stack.top
	...
	queue_plus (queue: QS_QUEUE_73): INTEGER
		note status: impure
		require
	...
	queue_minus (queue: QS_QUEUE_73): INTEGER
		note status: impure
		require
			two_things_in_queue: 3 <= queue.rear
			is_wrapped: queue.is_wrapped
	...
	queue_division (queue: QS_QUEUE_73): INTEGER
		note status: impure
		require
	...
	queue_modulus (queue: QS_QUEUE_73): INTEGER
		note status: impure
		require
			two_things_in_queue: 3 <= queue.rear
			is_wrapped: queue.is_wrapped
	...
	queue_plus_stack (queue: QS_QUEUE_73; stack: QS_STACK_73): INTEGER
		note status: impure
		require
	...
	queue_minus_stack (queue: QS_QUEUE_73; stack: QS_STACK_73): INTEGER
		note status: impure
		require
			one_thing_in_queue: queue.rear >= 2
			one_thing_on_stack: stack.top >= 2
	...
	queue_divide_stack (queue: QS_QUEUE_73; stack: QS_STACK_73): INTEGER
		note status: impure
		require
			one_thing_in_queue: queue.rear >= 2
			one_thing_on_stack: stack.top >= 2
	...
	stack_divide_queue (queue: QS_QUEUE_73; stack: QS_STACK_73): INTEGER
		note status: impure
		require
			one_thing_in_queue: queue.rear >= 2
			one_thing_on_stack: stack.top >= 2
	...
	queue_modulus_stack (queue: QS_QUEUE_73; stack: QS_STACK_73): INTEGER
		note status: impure
		require
			one_thing_in_queue: queue.rear >= 2
			one_thing_on_stack: stack.top >= 2
	...
	stack_modulus_queue (queue: QS_QUEUE_73; stack: QS_STACK_73): INTEGER
		note status: impure
		require
			one_thing_in_queue: queue.rear >= 2
			one_thing_on_stack: stack.top >= 2
	...
	driver_stack (stack: QS_STACK_73; op: INTEGER; input: INTEGER): INTEGER
		note
			status: impure
		require
	...
	driver_queue (queue: QS_QUEUE_73; op: INTEGER; input: INTEGER): INTEGER
		note
			status: impure
		require
	...
	driver_queue_stack (stack: QS_STACK_73; queue: QS_QUEUE_73; op: INTEGER): INTEGER
		note
			status: impure
		require
